...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_filepath", type=str, default="",
                        help="直接指定数据文件路径（.json 或 .jsonl），优先级高于 --dataset 自动推断")
    parser.add_argument("--dataset", type=str, default="competition", choices=["competition",
                                                                        "gaia", 
    ...
    # Create output directory structure: output_base/model_name/dataset_name/
